...
export const ViewModeControl = ({ defValue, onChange }: ViewModeControlProps) => {
    ...
    return (<Tabs defaultValue={defValue?? "COMFY"} className="w-[122px]">
                <TabsList  className="grid bg-muted p-1 rounded-lg grid-cols-3 w-max">
