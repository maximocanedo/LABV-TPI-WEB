...
import {IPatient, IPatientUpdateRequest, Patient} from "../../../../entity/patients";
...
const getUpdatedValues = (values: z.infer<typeof formSchema>, doc: Patient): IPatientUpdateRequest | null => {
...
export const CommunicationInfoCard = ({ }: BasicInfoCardProps) => {
    const {record: e, updater } = useContext(CurrentPatientContext);
    const record = e as Patient;
