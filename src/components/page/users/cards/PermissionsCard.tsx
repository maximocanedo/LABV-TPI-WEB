                ...
                <Accordion type="single" collapsible>
                    <AccordionItem value={"specialties"}>
                        ...
                        <AccordionContent>
                            ...
                            <PermissionItem user={user} action={Permits.READ_DISABLED_SPECIALTY_RECORDS} label={"Leer registros deshabilitados"} />
                    ...
                    <AccordionItem value={"patients"}>
                        ...
                        <AccordionContent>
                            ...
                            <PermissionItem user={user} action={Permits.READ_PATIENT_PERSONAL_DATA} label={"Leer datos personales"} />
                            <PermissionItem user={user} action={Permits.READ_PATIENT_APPOINTMENTS} label={"Acceder a turnos individuales"} />
                    ...
                    <AccordionItem value={"doctors"}>
                        ...
                        <AccordionContent>
                            ...
                            <PermissionItem user={user} action={Permits.READ_DOCTOR_APPOINTMENTS} label={"Acceder a turnos individuales"} />
                            <PermissionItem user={user} action={Permits.UPDATE_DOCTOR_PERSONAL_DATA} label={"Modificar"} />
                            <PermissionItem user={user} action={Permits.UPDATE_DOCTOR_SCHEDULES} label={"Actualizar horarios"} />
                    ...
                    <AccordionItem value={"users"}>
                        ...
                        <AccordionContent>
                            ...
                            <PermissionItem user={user} action={Permits.RESET_PASSWORD} label={"Restablecer contraseñas"} />
                            <PermissionItem user={user} action={Permits.UPDATE_USER_DATA} label={"Actualizar información personal"} />
                            <PermissionItem user={user} action={Permits.DELETE_OR_ENABLE_USER} label={"Habilitar y deshabilitar"} />
                            <PermissionItem user={user} action={Permits.READ_USER_DATA} label={"Leer datos personales"} />
                            <PermissionItem user={user} action={Permits.READ_USER_SESSIONS} label={"Ver sesiones abiertas"} />
